# Sphere segmentation and fitting routine
This repository was created to disseminate the algorithms that are used to process data obtained from 3D scanners. Specifically this algorithm processes scanned data of spheres and outputs the segmented data and the sphere center. 
